...
<?php include PATH_VIEW."/components/navbar.php"; ?>
     <main>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-9 col-xl-10">
                    <div class="row mt-3 gap-3">
                            <div class="col-12">
                                <h3 class="d-inline">Section List</h3>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="addModalLabel">Add New Section</h1>
                    </div>
                    <form class="postForm" method="POST" action="<?php echo ROOT;?>manage_section/store">
                            ...
                            <div class="row gap-3 mt-3">
                                        ...
                                        <select class="form-control" name="grade" id="grade" required>
                                            ...
                                            <?php 
                                                foreach($data as $result) { 
                                                    if($result['status'] == 1)
                                                    {
                                                        echo '<option value="'.$result['id'].'">'.$result['grade'].'</option>';
                                                    }
                                                }
                                            ?>
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="section" id="section" placeholder="Please enter section." required>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="postForm" method="POST" action="<?php echo ROOT;?>manage_section/update">
                        <div class="modal-body">
                            <input class="form-control id" type="text" name="id" readonly hidden>
                            <input class="form-control" type="text" name="e_grade_id" id="e_grade_id" readonly hidden>
                            <div class="row gap-3 mt-3">
                                <div class="col-12">
                                    <div class="input-group">
                                        <span class="input-group-text w-25">
                                        ...
                                        <input class="form-control" type="text" name="e_grade" id="e_grade" required readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="e_section" id="e_section" placeholder="Please enter section." required>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h1 class="modal-title fs-5" id="deleteModalLabel">Delete Section</h1>
                    </div>
                    <form class="postForm" method="POST" action="<?php echo ROOT;?>manage_section/delete">
                        <div class="modal-body">
                            <input class="form-control id" type="text" name="id" readonly hidden>
        ...
        <script>
            ...
            const sidebarName = document.querySelectorAll(".manage_section");
            ...
            $('.edit_button').on('click', function() {
                const path = '<?php echo ROOT; ?>manage_section/edit';
                ...
                $.ajax({
                    ...
                    success  : function(data) {
                        ...
                        const json = JSON.parse(data);
                        $('.id').val(json['id']);
                        $('#e_grade_id').val(json['grade_id']);
                        $('#e_grade').val(json['grade']);
                        $('#e_section').val(json['section']);
